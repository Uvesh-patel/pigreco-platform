...
REM This script sets up the complete PIGRECO platform including the Lomellina case study
...
REM Reset database and run migrations and main seeds
...
REM Explicitly run the Lomellina scenario to ensure it's loaded
